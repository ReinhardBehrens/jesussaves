...
The built-in image tool isolated the icon from the supplied landscape image. The output was copied unchanged into `docs/logo-3d-transparent.png`; transparency was verified from its RGBA alpha channel.
