...
files.update({'LICENSE':'LICENSE','licenses/DejaVu.txt':'licenses/DejaVu.txt','windows/README-Windows.md':'README-Windows.md','windows/install.cmd':'install.cmd','windows/install.ps1':'install.ps1','licenses/SDL2.txt':'SDL2-LICENSE.txt'})
